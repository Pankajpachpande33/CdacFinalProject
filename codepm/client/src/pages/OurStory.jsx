...
<br/><br/><br/>
  <div className='container-fluid background1'>
    <div className='row'>
    <div className='col-6'><br/><br/>
      <h1 className='font1'><b>Established in 2010, <br/>Gurgaon, India.</b></h1><br/><br/>
      
      <p>We are headquartered in Gurgaon, India near the capital city of New Delhi. Our objective has always been to empower our artisans to deliver sustainable products of the finest quality. We devote ourselves to these causes. Each of our products are handcrafted and unique. Each product tells the unique story of the artisan who made it.</p>
    </div>
    <div className='col-6'>
    <div><br/><br/><br/><br/>
      <img className='img-left' src="img/workers5.PNG"></img><br/><br/><br/><br/>
    </div>
    </div>
    </div>
    <br/><br/><br/>
  ...
  <div className='container-fluid background3'>
    <div className='row'>
    <div className='col-6'><br/><br/><br/><br/>
<h1 className='font1'><b>Celebrating a heritage.<br/> Home to some of the <br/>world’s oldest craft forms.</b></h1><br/><br/><br/><br/><br/>
<p>With a legacy of craft that spans millennia and some of the forms dating as far back as to the era of the Indus Valley civilisation, the fantastic world of India’s crafts people remains unsurpassed in its beauty and extent. “Craftsmanship in India comes naturally to hundreds of thousands of its unlettered people who weave myths, legends and simple daily experiences into different forms of creativity that can change shape from day to day, yet maintain their consistency for centuries to enrich their lives. There are many different worlds contained within the geographical boundaries of India. The world of its craftspeople, with their hand made goods and textiles, spans millennia and spreads across the length and breadth of the land. To hundreds and thousands of Indian artisans, fusion of utility and aesthetics comes naturally…”</p>
    <div>
    <br/><br/><br/><br/><br/><img src="img/workers1.PNG"></img><br/><br/>
    </div>
    </div>
    <div className='col-6'>
...
<div className='container-fluid background5'>
<div className='row'>
<div className='col-6'><br/><br/>
<h1 className='font1'> <b>
Rewarding partnerships<br/> with a deserving force
</b></h1><br/><br/>
<p>
...
<div className='col-6'><br/><br/>
    <div>
    <br/><br/><img src='img/workers3.png'/><br/><br/>
    </div><br/><br/>
</div>
</div>
</div>
...
<div className='container-fluid background6'>
<div className='row'>
<div className='col-6'>
  <div>
  <br/><br/><img src='img/workers3.png'/><br/><br/>
...
<div className='col-6'><br/><br/><br/>
<h1 className='font1'><b>Supporting eco-<br/>friendly choices</b></h1><br/><br/><br/>

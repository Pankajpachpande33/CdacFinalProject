...
public class ProductServiceImpl implements  ProductService{
    ...
    public String saveProduct( ProductVM productVM) {
        ...
        Optional<CategoryMaster> categoryMaster = categoryRepo.findById(productVM.getCategoryId());
        ...
        if (!categoryMaster.isPresent() && !subCategoryMaster.isPresent() && !sellerMaster.isPresent())
            return " Category ID and Sub Category ID and Seller Id must be present";
        productMaster.setCategoryMaster(categoryMaster.get());
